document.addEventListener("DOMContentLoaded", function() {
  ...
  circles.forEach(function(circle) {
    var percent = circle.parentElement.getAttribute('data-percent');
    var circumference = 2 * Math.PI * 45; // Circumference of circle with radius 45
    var offset = circumference * (1 - percent / 100); // Calculate the offset
    console.log('percent');
    console.log(percent);
    circle.style.strokeDasharray = circumference;
    circle.style.strokeDashoffset = offset;
    circle.style.stroke = 'yellow'; // Set stroke color to yellow
  });
});
